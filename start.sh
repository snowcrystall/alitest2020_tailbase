...
then
   ...
   /usr/local/tailtrace/agentd -bufn 5000  -port 8000 -rpcport 50000 -filename trace1.data 2>&1 
elif [ "$SERVER_PORT" = "8001" ];  
then
    echo "Starting the agentd port 8001"
   /usr/local/tailtrace/agentd -bufn 5000 -port 8001 -rpcport 50001  -filename trace2.data 2>&1 
